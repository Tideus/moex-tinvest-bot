...
| `schedule.daily_report_on_calendar` | однострочное systemd `OnCalendar` | Время итогового Telegram-отчёта по всем shadow BUY/SELL за московский день. По умолчанию `23:20`. |
...
`daily_turnover` брокера пока не восстанавливается из операций и равен нулю; это ограничение
нужно устранить до включения автоматической отправки заявок.
